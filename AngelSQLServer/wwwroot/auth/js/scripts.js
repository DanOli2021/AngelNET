...
async function getPermissions(session_data) {
  ...
  var data = { OperationType: "GetPermisionsUsingtoken", Token: session_object.token };
...
async function getBranchStoresUsingtoken(session_data) {
  ...
  var data = { OperationType: "GetBranchStoreByUser", Token: session_object.token };
  var api = {
...
async function getBranchStore(session_data, BranchStore) {
    ...
    var data = { OperationType: "GetBranchStore", Token: session_object.token, id: BranchStore };
    var api = {
        api: "auth/adminbranchstores",
        account: account,
        message: JSON.stringify(data),
