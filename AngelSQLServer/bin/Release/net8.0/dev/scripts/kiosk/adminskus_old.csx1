...
public class AdminSkus
{
    ...
    public string UpsertClasifications(AngelDB.DB db, Dictionary<string, string> servers, string token, AngelApiOperation api)
    {

        string result = ValidatePermisions(db, servers, api.Token, "AUTHORIZERS, ADMINISTRATIVE");
    ...
    static public string ValidatePermisions(AngelDB.DB db, Dictionary<string, string> servers, string token, string group_name)
    {
        string result = "";
    ...
    public string GetPermisions(AngelDB.DB db, string server_url, AngelApiOperation api)
    {
        string result = "";
