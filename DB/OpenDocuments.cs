    ...
    public static class OpenDocuments
    {
        ...
        public static string ReadExcelAsJson(string fname, AngelDB.DB db, string as_table, bool firstRowIsHeader = true, string sheet_name = "") 
        {
            try
            {
                ...
                DataTable t = ReadExcelSheet(fname, firstRowIsHeader, sheet_name);
        ...
        public static DataTable ReadExcelSheet(string fname, bool firstRowIsHeader = true, string sheet_name = "")
        {
        ...
        public static string CreateExcelFile(DataTable table, string destination)
        {
            try
            {
                var ds = new DataSet();
